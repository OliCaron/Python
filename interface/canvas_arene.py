...
class CanvasArene(Canvas):
    ...
    def dessiner_de(self, coordonnees, gauche, haut, droite, bas):
        ...
        if texte_de.isnumeric() or texte_de == 'X':
            ...
            r = (droite - gauche) // 10
            texte_de = self.arene.des[coordonnees].valeur
            if texte_de == 'X':
                self.create_text((gauche + droite) // 2, (haut + bas) // 2, fill='black', font="Times 20 bold")
            elif texte_de == 2:
                self.create_oval(gauche + r, haut + r, gauche + 3 * r, haut + 3 * r, fill='black')
                self.create_oval(droite - 3 * r, bas - 3 * r, droite - r, bas - r, fill='black')
            elif texte_de == 3:
                self.create_oval(gauche + r, haut + r, gauche + 3 * r, haut + 3 * r, fill='black')
                self.create_oval(gauche + 4 * r, haut + 4 * r, gauche + 6 * r, haut + 6 * r, fill='black')
                self.create_oval(droite - 3 * r, bas - 3 * r, droite - r, bas - r, fill='black')
            elif texte_de == 4:
                self.create_oval(gauche + r, haut + r, gauche + 3 * r, haut + 3 * r, fill='black')
                self.create_oval(droite - 3 * r, haut + r, droite - r, haut + 3 * r, fill='black')
                self.create_oval(gauche + r, bas - 3 * r, gauche + 3 * r, bas - r, fill='black')
                self.create_oval(droite - 3 * r, bas - 3 * r, droite - r, bas - r, fill='black')
            elif texte_de == 5:
                self.create_oval(gauche + r, haut + r, gauche + 3 * r, haut + 3 * r, fill='black')
                self.create_oval(droite - 3 * r, haut + r, droite - r, haut + 3 * r, fill='black')
                ...
                self.create_oval(gauche + r, haut + r, gauche + 3 * r, haut + 3 * r, fill='black')
                self.create_oval(droite - 3 * r, haut + r, droite - r, haut + 3 * r, fill='black')
                self.create_oval(gauche + r, haut + 4 * r, gauche + 3 * r, bas - 4 * r, fill='black')
                self.create_oval(droite - 3 * r, haut + 4 * r, droite - r, bas - 4 * r, fill='black')
                self.create_oval(gauche + r, bas - 3 * r, gauche + 3 * r, bas - r, fill='black')
                self.create_oval(droite - 3 * r, bas - 3 * r, droite - r, bas - r, fill='black')
